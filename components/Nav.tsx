        ...
        <nav className="flex items-center justify-between flex-wrap bg-gray-800 p-6">
            ...
            <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                ...
                <div>
                    {session === null ? 
                        <Link href="/login">
                            <div className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-gray-800 hover:bg-white mt-4 lg:mt-0">
                                Login
                            </div>
                        </Link>:
                        <Link href="/logout">
